...
func NewFileIOProxy(clnts map[int64]*grpc.ClientConn, dedupeEnabled map[int64]bool, debug bool) (*FileIOProxy, error) {
	...
	sc := &FileIOProxy{fc: fcm, dedupeEnabled: dedupeEnabled, dedupe: dd, dfc: defaultVolume}
	return sc, nil
